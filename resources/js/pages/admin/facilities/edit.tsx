...
export default function FacilityEditPage({ facility }: Props) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <Form method="put" action={`/admin/facilities/${facility.id}`} className="flex flex-col gap-6 p-4">
                {({ processing, errors }) => (
                    <>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Input
                                        ...
                                        type="number"
                                        min={0}
                                        defaultValue={facility.waitlist_limit}
                                    />
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Input
                                        ...
                                        min={0}
                                        step={0.01}
                                        defaultValue={facility.hourly_rate}
                                    />
                                ...
                                <div className="space-y-2">
                                    <div className="flex items-center gap-2 rounded-lg border border-dashed border-muted-foreground/40 p-3">
                                        <Checkbox
                                            ...
                                            value="1"
                                            defaultChecked={facility.requires_membership}
                                        />
                                    ...
                                    <div className="flex items-center gap-2 rounded-lg border border-dashed border-muted-foreground/40 p-3">
                                        <Checkbox id="is_active" name="is_active" value="1" defaultChecked={facility.is_active} />
